...
Add them in `dependencies` just like PostgreSQL. See [Configuration Reference](../configuration).

## Next Steps

- [Configuration Reference](../configuration) - All available options
- [Commands Reference](../commands) - All commands and flags
- [Deployment Guide](../deployment-guide) - Best practices and workflows
